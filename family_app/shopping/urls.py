...
from shopping.views import ShoppingListsView, ShoppingListView, ShoppingItemsListItemView, SubscribeToListView, \
...
urlpatterns = [
  path('lists/<int:list_id>/entries/<int:entry_id>/', ShoppingItemsListItemView.as_view(), name='shopping-list-item-details'),
